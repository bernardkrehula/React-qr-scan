    ...
    <>
      <div className='main'> 
        <div className='generate-div'>
          <SingleButton onClick={async() => {startTimer()}} disabled={generated || loading}>Generate</SingleButton>
        </div>
        <div className='qr-code-content'>
          ...
          <div className='qr-code-scanner' aria-disabled={generated}>
            ...
            <SingleButton onClick={() => {startTimer()}} disabled={generated}>Generate</SingleButton>
          </div>
