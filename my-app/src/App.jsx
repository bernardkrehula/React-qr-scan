    ...
    <>
      <div className='main'> 
        <div className='generate-div'>
          <SingleButton vartiation='generate' color={generated ? 'color' : ''}>Generate</SingleButton>
        </div>
        <div className='qr-code-content'>
          {generated ? <div className='qr-code-scanner' style={{backgroundColor: 'green'}}>
            ...
            <SingleButton vartiation='generate-qr-code' color='color' onClick={() => {isGenerated(prev => !prev)}}>Generate</SingleButton>
          </div> 
          : 
