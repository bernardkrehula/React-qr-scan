...
import CountDownTimmer from './CountDown'
    ...
    <>
      <div className='main'> 
        <div className='generate-div'>
          <SingleButton vartiation='generate' onClick={() => {isGenerated(prev => !prev)}}>Generate</SingleButton>
        </div>
        <div className='qr-code-content'>
          <div className='qr-code-scanner'>
            ...
            <SingleButton vartiation='generate-qr-code'>Generate</SingleButton>
          </div>
          <CountDownTimmer />
          <SingleButton vartiation='download'>Download</SingleButton>
        </div>
      </div>
    </>
  )
